...
DOCKER_NETWORK = 'financial-risk_default'
...
with DAG(
    ...
    save_to_hdfs = DockerOperator(
        ...
        mounts=[
            Mount(source='financial-risk_hadoop_conf', target='/opt/hadoop/conf', type='volume'),
            Mount(source='C:/Study/BigData/Financial-Risk/spark-jobs', target='/app', type='bind')
        ],
        environment={
    ...
    train_model = DockerOperator(
        ...
        mounts=[
            ...
            Mount(source='C:/Study/BigData/Financial-Risk/spark-jobs', target='/app', type='bind'),
            Mount(source='C:/Study/BigData/Financial-Risk/model_service', target='/models', type='bind')
        ],
        environment={
            'SPARK_HADOOP_FS_DEFAULTFS': 'hdfs://namenode:9000',
            'HADOOP_CONF_DIR': '/opt/hadoop/conf',
